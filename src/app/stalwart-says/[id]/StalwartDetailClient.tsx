...
interface StalwartDetailClientProps {
  event: StalwartEvent;
}
...
export default function StalwartDetailClient({ event }: StalwartDetailClientProps) {
    ...
    <div className="min-h-screen bg-slate-50/50 pb-20">
      ...
      >
        ...
        <div className="w-full px-6 sm:px-12 md:px-16 lg:pr-32 relative z-10 text-left">
          ...
          >
            ...
            Back to Stalwart Says
          </Link>

          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div className="space-y-2.5">
              <div className="flex gap-2 items-center flex-wrap">
                <span className="bg-[#1E3A8A]/5 text-[#1E3A8A] px-2.5 py-0.5 rounded text-[9px] font-extrabold uppercase tracking-wider">
                  Event Brief
                </span>
      ...
      <div className="w-full px-6 sm:px-12 md:px-16 lg:pr-32 mt-10">
        ...
        >
          ...
          <div className="lg:col-span-8 space-y-6 text-left">
            ...
            >
              ...
              <div className={`${fontSize} leading-relaxed text-slate-800 font-medium space-y-4`}>
                <p>{event.content}</p>
                <p>
                  Official reports regarding these matters have been submitted to corresponding legislative chambers, ministerial committees, and joint secretariats. Progress metrics, resource deployment indices, and follow-up activities will be recorded under standard cooperative governance databases.
                </p>
              </div>
              ...
              <div className="border-t border-slate-100 pt-6 flex items-center justify-between gap-4 text-xs font-bold text-slate-500 flex-wrap">
                ...
                <div className="flex gap-2">
                  ...
                  <a
                    href={`data:text/plain;charset=utf-8,${encodeURIComponent(event.event + "\n\n" + event.content)}`}
                    download={`${event.event.toLowerCase().replace(/\s+/g, "_")}.txt`}
          ...
          {/* Right Column: Leader Profile card, contacts & portals */}
          <div className="lg:col-span-4 space-y-6">
            ...
            >
              ...
              <h4 className="text-sm font-bold font-serif text-white mb-3">Official Event Brief</h4>
              <p className="text-[11px] leading-relaxed text-slate-400 font-medium mb-4">
                This event brief is certified and published on the official web portal. Security checksum verification stamp verified.
              </p>
